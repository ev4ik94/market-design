...
export default function ChangeForm({token: serverToken}) {
                ...
                form?(
                    <form className="col-6 mx-auto pt-5">
                        ...
                        <div className="form-group">
                            ...
                            <input type="password" className={`${error?'form-control isError':'form-control'}`} id="exampleInputPassword-reset" onChange={(e)=>setPassword1(e.target.value)}/>
                        </div>
                        <div className="form-group">
                            <label htmlFor="exampleInputPassword-reset2">CONFIRM PASSWORD *</label>
                            <input type="password" className={`${error?'form-control isError':'form-control'}`} id="exampleInputPassword-reset2" onChange={(e)=>setPassword2(e.target.value)}/>
                        </div>
